...
void OSBiQuadFilter::initializeState()
{
	x1 = x2 = 0.0;
	y0 = y1 = y2 = 0.0;
}

void OSBiQuadFilter::MakeByPass()
{
	g  = 1.0;
	b0 = 1.0;
	b1 = 0.0;
...
void OSBiQuadFilter::setCoefficients(double g_new, double b0_new, double b1_new, double b2_new, double a1_new, double a2_new)
{
	g  = g_new;
    b0 = b0_new;
    b1 = b1_new;
...
void OSBiQuadFilter::updateSample(double x0)
{
